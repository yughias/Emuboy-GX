...
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 0, *rd);
return;
thumb_op_0181:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 4, *rd);
return;
thumb_op_0182:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 8, *rd);
return;
thumb_op_0183:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 12, *rd);
return;
thumb_op_0184:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 16, *rd);
return;
thumb_op_0185:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 20, *rd);
return;
thumb_op_0186:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 24, *rd);
return;
thumb_op_0187:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 28, *rd);
return;
thumb_op_0188:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 32, *rd);
return;
thumb_op_0189:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 36, *rd);
return;
thumb_op_018A:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 40, *rd);
return;
thumb_op_018B:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 44, *rd);
return;
thumb_op_018C:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 48, *rd);
return;
thumb_op_018D:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 52, *rd);
return;
thumb_op_018E:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 56, *rd);
return;
thumb_op_018F:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 60, *rd);
return;
thumb_op_0190:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 64, *rd);
return;
thumb_op_0191:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 68, *rd);
return;
thumb_op_0192:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 72, *rd);
return;
thumb_op_0193:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 76, *rd);
return;
thumb_op_0194:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 80, *rd);
return;
thumb_op_0195:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 84, *rd);
return;
thumb_op_0196:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 88, *rd);
return;
thumb_op_0197:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 92, *rd);
return;
thumb_op_0198:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 96, *rd);
return;
thumb_op_0199:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 100, *rd);
return;
thumb_op_019A:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 104, *rd);
return;
thumb_op_019B:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 108, *rd);
return;
thumb_op_019C:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 112, *rd);
return;
thumb_op_019D:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 116, *rd);
return;
thumb_op_019E:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 120, *rd);
return;
thumb_op_019F:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
writeWord(cpu, rb + 124, *rd);
return;
thumb_op_01A0:
rb = cpu->r[(opcode >> 3) & 0b111];
rd = &cpu->r[opcode & 0b111];
...
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 0, *rd);
return;
thumb_op_0201:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 2, *rd);
return;
thumb_op_0202:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 4, *rd);
return;
thumb_op_0203:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 6, *rd);
return;
thumb_op_0204:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 8, *rd);
return;
thumb_op_0205:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 10, *rd);
return;
thumb_op_0206:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 12, *rd);
return;
thumb_op_0207:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 14, *rd);
return;
thumb_op_0208:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 16, *rd);
return;
thumb_op_0209:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 18, *rd);
return;
thumb_op_020A:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 20, *rd);
return;
thumb_op_020B:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 22, *rd);
return;
thumb_op_020C:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 24, *rd);
return;
thumb_op_020D:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 26, *rd);
return;
thumb_op_020E:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 28, *rd);
return;
thumb_op_020F:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 30, *rd);
return;
thumb_op_0210:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 32, *rd);
return;
thumb_op_0211:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 34, *rd);
return;
thumb_op_0212:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 36, *rd);
return;
thumb_op_0213:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 38, *rd);
return;
thumb_op_0214:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 40, *rd);
return;
thumb_op_0215:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 42, *rd);
return;
thumb_op_0216:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 44, *rd);
return;
thumb_op_0217:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 46, *rd);
return;
thumb_op_0218:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 48, *rd);
return;
thumb_op_0219:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 50, *rd);
return;
thumb_op_021A:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 52, *rd);
return;
thumb_op_021B:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 54, *rd);
return;
thumb_op_021C:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 56, *rd);
return;
thumb_op_021D:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 58, *rd);
return;
thumb_op_021E:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 60, *rd);
return;
thumb_op_021F:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
writeHalfWord(cpu, rb + 62, *rd);
return;
thumb_op_0220:
rd = &cpu->r[opcode & 0b111];
rb = cpu->r[(opcode >> 3) & 0b111];
*rd = readHalfWord(cpu, rb + 0);
if(rb & 1)
*rd = (*rd << 24) | (*rd >> 8);
return;
thumb_op_0221:
...
if(!should_transfer)
continue;
if(count == 0 && !first_transfer)writeWord(cpu, base, cpu->r[count] + (rlist_size << 2));
else
...
if(!should_transfer)
continue;
if(count == 1 && !first_transfer)writeWord(cpu, base, cpu->r[count] + (rlist_size << 2));
else
writeWord(cpu, base, cpu->r[count]);
base += 4;
first_transfer = false;
...
if(!should_transfer)
continue;
if(count == 2 && !first_transfer)writeWord(cpu, base, cpu->r[count] + (rlist_size << 2));
else
writeWord(cpu, base, cpu->r[count]);
base += 4;
first_transfer = false;
...
if(!should_transfer)
continue;
if(count == 3 && !first_transfer)writeWord(cpu, base, cpu->r[count] + (rlist_size << 2));
else
writeWord(cpu, base, cpu->r[count]);
base += 4;
first_transfer = false;
...
if(!should_transfer)
continue;
if(count == 4 && !first_transfer)writeWord(cpu, base, cpu->r[count] + (rlist_size << 2));
else
writeWord(cpu, base, cpu->r[count]);
base += 4;
first_transfer = false;
...
if(!should_transfer)
continue;
if(count == 5 && !first_transfer)writeWord(cpu, base, cpu->r[count] + (rlist_size << 2));
else
writeWord(cpu, base, cpu->r[count]);
base += 4;
first_transfer = false;
...
if(!should_transfer)
continue;
if(count == 6 && !first_transfer)writeWord(cpu, base, cpu->r[count] + (rlist_size << 2));
else
writeWord(cpu, base, cpu->r[count]);
base += 4;
first_transfer = false;
...
if(!should_transfer)
continue;
if(count == 7 && !first_transfer)writeWord(cpu, base, cpu->r[count] + (rlist_size << 2));
else
writeWord(cpu, base, cpu->r[count]);
base += 4;
first_transfer = false;
