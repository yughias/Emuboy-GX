...
dataProcessingFunc dataProcFuncs[16] = {
...
bool cond_EQ(arm7tdmi_t* cpu){ return cpu->Z_FLAG; }
bool cond_NE(arm7tdmi_t* cpu){ return !cpu->Z_FLAG; }
bool cond_CS(arm7tdmi_t* cpu){ return cpu->C_FLAG; }
bool cond_CC(arm7tdmi_t* cpu){ return !cpu->C_FLAG; }
bool cond_MI(arm7tdmi_t* cpu){ return cpu->N_FLAG; }
bool cond_PL(arm7tdmi_t* cpu){ return !cpu->N_FLAG; }
bool cond_VS(arm7tdmi_t* cpu){ return cpu->V_FLAG; }
bool cond_VC(arm7tdmi_t* cpu){ return !cpu->V_FLAG; }
bool cond_HI(arm7tdmi_t* cpu){ return cpu->C_FLAG && !cpu->Z_FLAG; }
bool cond_LS(arm7tdmi_t* cpu){ return !cpu->C_FLAG || cpu->Z_FLAG; }
bool cond_GE(arm7tdmi_t* cpu){ return cpu->N_FLAG == cpu->V_FLAG; }
bool cond_LT(arm7tdmi_t* cpu){ return cpu->N_FLAG != cpu->V_FLAG; }
bool cond_GT(arm7tdmi_t* cpu){ return !cpu->Z_FLAG && (cpu->N_FLAG == cpu->V_FLAG); }
bool cond_LE(arm7tdmi_t* cpu){ return cpu->Z_FLAG || (cpu->N_FLAG != cpu->V_FLAG); }
bool cond_AL(arm7tdmi_t* cpu){ return true; }
bool cond_Undefined(arm7tdmi_t* cpu){ printf("undefined cond!\n"); arm7tdmi_print(cpu); return true; }
